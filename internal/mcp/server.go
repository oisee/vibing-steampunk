...
func (s *Server) registerTools(mode string, disabledGroups string, toolsConfig map[string]bool) {
	...
	// GetRevisions - List version history of an object
	...
	// CompareVersions - Compare two versions of same object
	...
	// GetCodeCoverage - Run unit tests with coverage enabled
	...
	// GetSQLExplainPlan - Get SQL execution plan (HANA-only)
	...
	// GetCheckRunResults - Get detailed check run findings
