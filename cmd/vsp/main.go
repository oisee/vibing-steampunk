...
Two modes of operation:
  ...
  MCP Server (default)  Connects Claude, Gemini CLI, Copilot, Codex, Qwen Code,
                        ...
                        101 tools (focused), 146 (expert), or 1 universal tool (hyperfocused).
...
func init() {
	...
	// Mode options
	rootCmd.Flags().StringVar(&cfg.Mode, "mode", "hyperfocused", "Tool mode: hyperfocused (single universal SAP tool), focused (101 tools), or expert (146 tools)")
